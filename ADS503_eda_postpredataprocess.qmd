...
```{r}
heart_data <- read.csv("heart_preprocessed_training.csv")
...
## 3. Correlation of Numeric Variables
...
## 4. Visualization for Categorical Variables
...
All variables in data set will be used for modeling. No dimensionality reduction needed.
