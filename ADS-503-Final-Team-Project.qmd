...
#move testResults data.frame creation to first created model when ready 
#testResults <- data.frame(obs = heart_test$HeartDisease, <modelname> = predict(<modelname>, heart_test[, 1:11]))
```

## Ridge Logistic Regression (alpha = 0)

```{r, fig.width=8, fig.height=7}
#ridgeGrid <- expand.grid(alpha = 0, lambda = seq(0, .1, length = 15))
...
```{r, fig.width=8, fig.height=7}
#lassoGrid <- expand.grid(alpha = 1, lambda = seq(0, .1, length = 15))
